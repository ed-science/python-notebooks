...
class ManagedNotebookServiceClientMeta(type):
    """Metaclass for the ManagedNotebookService client.
...
class ManagedNotebookServiceClient(metaclass=ManagedNotebookServiceClientMeta):
    ...
    def from_service_account_info(cls, info: dict, *args, **kwargs):
        ...
        Returns:
            ManagedNotebookServiceClient: The constructed client.
        """
    ...
    def transport(self) -> ManagedNotebookServiceTransport:
        ...
        Returns:
            ManagedNotebookServiceTransport: The transport used by the client
                instance.
        """
        return self._transport

    @staticmethod
    def runtime_path(project: str, location: str, runtime: str,) -> str:
        """Returns a fully-qualified runtime string."""
        return "projects/{project}/locations/{location}/runtimes/{runtime}".format(
            project=project, location=location, runtime=runtime,
        )

    @staticmethod
    def parse_runtime_path(path: str) -> Dict[str, str]:
        """Parses a runtime path into its component segments."""
        m = re.match(
            r"^projects/(?P<project>.+?)/locations/(?P<location>.+?)/runtimes/(?P<runtime>.+?)$",
            path,
        )
    ...
    def list_runtimes(
        ...
        *,
        ...
        response = pagers.ListRuntimesPager(
    ...
    def get_runtime(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.get_runtime]
    ...
    def create_runtime(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.create_runtime]
    ...
    def delete_runtime(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.delete_runtime]
    ...
    def start_runtime(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.start_runtime]
    ...
    def stop_runtime(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.stop_runtime]
    ...
    def switch_runtime(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.switch_runtime]
    ...
    def reset_runtime(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.reset_runtime]
    ...
    def report_runtime_event(
        ...
        *,
        ...
        # Wrap the RPC method; this adds retry and timeout information,
        # and friendly error handling.
        rpc = self._transport._wrapped_methods[self._transport.report_runtime_event]
...
__all__ = ("ManagedNotebookServiceClient",)
