...
def test_list_instances_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.list_instances(
            service.ListInstancesRequest(), parent="parent_value",
        )
...
@pytest.mark.parametrize("request_type", [service.UpdateInstanceConfigRequest, dict,])
...
@pytest.mark.parametrize(
    "request_type", [service.UpdateShieldedInstanceConfigRequest, dict,]
)
...
def test_delete_instance_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.delete_instance(
            service.DeleteInstanceRequest(), name="name_value",
        )
...
@pytest.mark.parametrize("request_type", [service.GetInstanceHealthRequest, dict,])
...
def test_get_instance_health_flattened():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.get_instance_health(name="name_value",)
...
def test_get_instance_health_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.get_instance_health(
            service.GetInstanceHealthRequest(), name="name_value",
        )
...
async def test_get_instance_health_flattened_async():
    ...
    with mock.patch.object(
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.get_instance_health(name="name_value",)
...
@pytest.mark.parametrize("request_type", [service.ListSchedulesRequest, dict,])
...
def test_list_schedules_flattened():
    ...
    with mock.patch.object(type(client.transport.list_schedules), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.list_schedules(parent="parent_value",)
...
def test_list_schedules_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.list_schedules(
            service.ListSchedulesRequest(), parent="parent_value",
        )
...
async def test_list_schedules_flattened_async():
    ...
    with mock.patch.object(type(client.transport.list_schedules), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.list_schedules(parent="parent_value",)
...
def test_list_schedules_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_schedules), "__call__") as call:
        ...
        call.side_effect = (
            ...
            service.ListSchedulesResponse(schedules=[], next_page_token="def",),
            service.ListSchedulesResponse(
                schedules=[schedule.Schedule(),], next_page_token="ghi",
            ),
            service.ListSchedulesResponse(
                schedules=[schedule.Schedule(), schedule.Schedule(),],
            ),
            RuntimeError,
        )
...
async def test_list_schedules_async_pages():
    ...
    with mock.patch.object(
        ...
        pages = []
        async for page_ in (await client.list_schedules(request={})).pages:
            pages.append(page_)
        for page_, token in zip(pages, ["abc", "def", "ghi", ""]):
            assert page_.raw_page.next_page_token == token


@pytest.mark.parametrize("request_type", [service.GetScheduleRequest, dict,])
...
def test_get_schedule_flattened():
    ...
    with mock.patch.object(type(client.transport.get_schedule), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.get_schedule(name="name_value",)
...
def test_get_schedule_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.get_schedule(
            service.GetScheduleRequest(), name="name_value",
        )
...
async def test_get_schedule_flattened_async():
    ...
    with mock.patch.object(type(client.transport.get_schedule), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.get_schedule(name="name_value",)
...
@pytest.mark.parametrize("request_type", [service.DeleteScheduleRequest, dict,])
...
def test_delete_schedule_flattened():
    ...
    with mock.patch.object(type(client.transport.delete_schedule), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        client.delete_schedule(name="name_value",)
...
def test_delete_schedule_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.delete_schedule(
            service.DeleteScheduleRequest(), name="name_value",
        )
...
async def test_delete_schedule_flattened_async():
    ...
    with mock.patch.object(type(client.transport.delete_schedule), "__call__") as call:
        ...
        # Call the method with a truthy value for each flattened field,
        # using the keyword arguments to the method.
        response = await client.delete_schedule(name="name_value",)
...
@pytest.mark.parametrize("request_type", [service.CreateScheduleRequest, dict,])
...
@pytest.mark.parametrize("request_type", [service.TriggerScheduleRequest, dict,])
...
@pytest.mark.parametrize("request_type", [service.ListExecutionsRequest, dict,])
...
def test_list_executions_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.list_executions(
            service.ListExecutionsRequest(), parent="parent_value",
        )
...
def test_list_executions_pager(transport_name: str = "grpc"):
    ...
    with mock.patch.object(type(client.transport.list_executions), "__call__") as call:
        ...
        call.side_effect = (
            ...
            service.ListExecutionsResponse(executions=[], next_page_token="def",),
            service.ListExecutionsResponse(
...
@pytest.mark.parametrize("request_type", [service.GetExecutionRequest, dict,])
...
@pytest.mark.parametrize("request_type", [service.DeleteExecutionRequest, dict,])
...
def test_delete_execution_flattened_error():
    ...
    with pytest.raises(ValueError):
        client.delete_execution(
            service.DeleteExecutionRequest(), name="name_value",
        )
...
@pytest.mark.parametrize("request_type", [service.CreateExecutionRequest, dict,])
